...
insert into Customer (CustID, Email, Phone_Number, Username, Password, First_Name, Last_Name, Birth_Month, Day_Of_Birth, Year_Of_Birth, Street, Country, City, Zip_Code, State, Support_Rep_id) values ('0576233818', 'hgratton0@mashable.com', '334-298-3882', 'hgratton0', 'Qhnt35GsdxN', 'Hilda', 'Gratton', 6, 9, 2006, 'Dryden', 'United States', 'Birmingham', '6252025', 'Alabama', '6298758097');
insert into Customer (CustID, Email, Phone_Number, Username, Password, First_Name, Last_Name, Birth_Month, Day_Of_Birth, Year_Of_Birth, Street, Country, City, Zip_Code, State, Support_Rep_id) values ('4342204366', 'dortas1@yahoo.com', '574-737-8502', 'dortas1', 'cf9L8g', 'Damian', 'Ortas', 6, 23, 1993, 'Kingsford', 'United States', 'South Bend', '6557532', 'Indiana', '6121460030');
insert into Customer (CustID, Email, Phone_Number, Username, Password, First_Name, Last_Name, Birth_Month, Day_Of_Birth, Year_Of_Birth, Street, Country, City, Zip_Code, State, Support_Rep_id) values ('7018339376', 'mbraker2@joomla.org', '832-145-6415', 'mbraker2', 'k9w1xpHoP', 'Matthieu', 'Braker', 10, 14, 1985, 'Hayes', 'United States', 'Houston', '7587272', 'Texas', '4459457891');
insert into Customer (CustID, Email, Phone_Number, Username, Password, First_Name, Last_Name, Birth_Month, Day_Of_Birth, Year_Of_Birth, Street, Country, City, Zip_Code, State, Support_Rep_id) values ('6136802201', 'hdurden3@people.com.cn', '682-293-9486', 'hdurden3', 'vUh9Iwp', 'Horatia', 'Durden', 10, 13, 2019, 'Meadow Vale', 'United States', 'Fort Worth', '3650144', 'Texas', '9597639208');
insert into Customer (CustID, Email, Phone_Number, Username, Password, First_Name, Last_Name, Birth_Month, Day_Of_Birth, Year_Of_Birth, Street, Country, City, Zip_Code, State, Support_Rep_id) values ('8346207528', 'gcote4@merriam-webster.com', '859-310-8660', 'gcote4', 'cHqi6vp4dOjQ', 'Gnni', 'Cote', 5, 1, 1998, 'Crownhardt', 'United States', 'Lexington', '8312912', 'Kentucky', '2809029423');
insert into Customer (CustID, Email, Phone_Number, Username, Password, First_Name, Last_Name, Birth_Month, Day_Of_Birth, Year_Of_Birth, Street, Country, City, Zip_Code, State, Support_Rep_id) values ('1350068223', 'cbrightie5@soup.io', '772-684-8989', 'cbrightie5', 'nkjmqf', 'Chaim', 'Brightie', 8, 12, 2016, 'Clemons', 'United States', 'Fort Pierce', '1027525', 'Florida', '9579492284');
insert into Customer (CustID, Email, Phone_Number, Username, Password, First_Name, Last_Name, Birth_Month, Day_Of_Birth, Year_Of_Birth, Street, Country, City, Zip_Code, State, Support_Rep_id) values ('0949877970', 'egilkison6@t-online.de', '601-853-8268', 'egilkison6', '86YrmRS7HcBa', 'Evvy', 'Gilkison', 4, 1, 1992, 'Maple Wood', 'United States', 'Jackson', '8799199', 'Mississippi', '9114180894');
insert into Customer (CustID, Email, Phone_Number, Username, Password, First_Name, Last_Name, Birth_Month, Day_Of_Birth, Year_Of_Birth, Street, Country, City, Zip_Code, State, Support_Rep_id) values ('5373314290', 'ypuckinghorne7@multiply.com', '772-618-4904', 'ypuckinghorne7', 'tSUqpVzz1', 'Yance', 'Puckinghorne', 1, 5, 2005, 'Vahlen', 'United States', 'Fort Pierce', '3441864', 'Florida', '2370595082');
insert into Customer (CustID, Email, Phone_Number, Username, Password, First_Name, Last_Name, Birth_Month, Day_Of_Birth, Year_Of_Birth, Street, Country, City, Zip_Code, State, Support_Rep_id) values ('3717830517', 'jgotobed8@economist.com', '210-130-3870', 'jgotobed8', 'NUrnSnjxn', 'Joli', 'Gotobed', 11, 11, 2011, 'Haas', 'United States', 'San Antonio', '8374344', 'Texas', '8138751160');
insert into Customer (CustID, Email, Phone_Number, Username, Password, First_Name, Last_Name, Birth_Month, Day_Of_Birth, Year_Of_Birth, Street, Country, City, Zip_Code, State, Support_Rep_id) values ('6378104203', 'rtruelock9@omniture.com', '713-939-0264', 'rtruelock9', 'gEWTRUXy0', 'Rennie', 'Truelock', 7, 8, 2012, 'Onsgard', 'United States', 'Houston', '4788416', 'Texas', '7647636297');
...
insert into Manufacturer (ManufacturerID, Country, State_Or_Territory, Email, PhoneNum, First_Name, Last_Name, Username, Password) values ('9473247069', 'China', null, 'smotherwell0@un.org', '725-835-6598', 'Sid', 'Motherwell', 'smotherwell0', 'JC2Pho');
insert into Manufacturer (ManufacturerID, Country, State_Or_Territory, Email, PhoneNum, First_Name, Last_Name, Username, Password) values ('3384934458', 'Philippines', null, 'ogeach1@google.it', '640-412-6354', 'Ozzy', 'Geach', 'ogeach1', 'cYu8y7');
insert into Manufacturer (ManufacturerID, Country, State_Or_Territory, Email, PhoneNum, First_Name, Last_Name, Username, Password) values ('6071011070', 'China', null, 'ccalan2@webmd.com', '547-386-1805', 'Connor', 'Calan', 'ccalan2', 'i2VO5nmRM');
insert into Manufacturer (ManufacturerID, Country, State_Or_Territory, Email, PhoneNum, First_Name, Last_Name, Username, Password) values ('3491167110', 'Portugal', 'Braga', 'boshirine3@desdev.cn', '156-921-6635', 'Bettye', 'O''Shirine', 'boshirine3', '65SbfwfXPm');
insert into Manufacturer (ManufacturerID, Country, State_Or_Territory, Email, PhoneNum, First_Name, Last_Name, Username, Password) values ('9373126228', 'Brazil', null, 'rmingus4@cbslocal.com', '350-393-7618', 'Raffarty', 'Mingus', 'rmingus4', 'YlOXIadS');
insert into Manufacturer (ManufacturerID, Country, State_Or_Territory, Email, PhoneNum, First_Name, Last_Name, Username, Password) values ('4381046908', 'Sweden', 'Södermanland', 'lwilne5@desdev.cn', '320-415-3884', 'Lorianna', 'Wilne', 'lwilne5', 'tEugP22');
insert into Manufacturer (ManufacturerID, Country, State_Or_Territory, Email, PhoneNum, First_Name, Last_Name, Username, Password) values ('1073811902', 'Chile', null, 'kbims6@timesonline.co.uk', '895-109-0744', 'Kacy', 'Bims', 'kbims6', '06Z82r4Q');
insert into Manufacturer (ManufacturerID, Country, State_Or_Territory, Email, PhoneNum, First_Name, Last_Name, Username, Password) values ('2658641613', 'Brazil', null, 'eshillitto7@prlog.org', '459-743-9322', 'Edgard', 'Shillitto', 'eshillitto7', 'gZQerN');
insert into Manufacturer (ManufacturerID, Country, State_Or_Territory, Email, PhoneNum, First_Name, Last_Name, Username, Password) values ('2138867807', 'Egypt', null, 'ctesmond8@blogger.com', '565-925-3264', 'Carmelina', 'Tesmond', 'ctesmond8', 'b1SElj');
insert into Manufacturer (ManufacturerID, Country, State_Or_Territory, Email, PhoneNum, First_Name, Last_Name, Username, Password) values ('7465921943', 'China', null, 'tjillions9@free.fr', '435-720-7126', 'Thomas', 'Jillions', 'tjillions9', 'EnaDPEjd');